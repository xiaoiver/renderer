...
export class MSCTranscoder extends Transcoder {
   ...
   */
  public static JSModuleURL =
    'https://preview.babylonjs.com/ktx2Transcoders/1/msc_basis_transcoder.js';
  /**
   * URL to use when loading the wasm module for the transcoder
   */
  public static WasmModuleURL =
    'https://preview.babylonjs.com/ktx2Transcoders/1/msc_basis_transcoder.wasm';
  ...
  private _getMSCBasisTranscoder(): Promise<void> {
    ...
    this._mscBasisTranscoderPromise = WASMMemoryManager.LoadWASM(
      MSCTranscoder.WasmModuleURL,
    ).then((wasmBinary) => {
  ...
  public transcode(
    ...
    return this._getMSCBasisTranscoder().then(() => {
      ...
      try {
        ...
        const targetFormat =
          basisModule.TranscodeTarget[KTX2.TranscodeTarget[dst]]; // works because the labels of the sourceTextureFormat enum are the same as the property names used in TranscodeTarget!
